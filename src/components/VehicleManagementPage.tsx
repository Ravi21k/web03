      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                {partner.type === 'vehicle_owner' ? 'Vehicle Management' : 'Material Management'}
              </h1>
          ...
          <div className="flex space-x-8">
            {[
              { id: 'vehicles', label: partner.type === 'vehicle_owner' ? 'My Vehicles' : 'My Materials' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto mb-8">
              Manage your {partner.type === 'vehicle_owner' ? 'construction vehicles' : 'materials'} and track customer feedback
            </p>
            ...
            <div className="space-y-8">
              ...
              <div className="flex justify-between items-center">
                <h2 className="text-3xl font-bold text-gray-900">
                  My {partner.type === 'vehicle_owner' ? 'Vehicles' : 'Material Vehicles'}
                </h2>
                <button
                ...
                >
                  <span>{partner.type === 'vehicle_owner' ? 'Add New Vehicle' : 'Add New Material'}</span>
                </button>
              </div>
              ...
              {vehicles.length > 0 ? (
                ...
                <div className="text-center py-16">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">No Vehicles Added Yet</h3>
                  <p className="text-gray-600 mb-8">Start by adding your first vehicle to attract customers</p>
                  <button
                    onClick={() => setShowAddForm(true)}
                  ...
                  >
                    {partner.type === 'vehicle_owner' ? 'Add Your First Vehicle' : 'Add Your First Material'}
                  </button>
                </div>
              )}
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  >
                    <option value="">Select {partner.type === 'vehicle_owner' ? 'Vehicle' : 'Material'} Type</option>
              ...
              <div className="flex space-x-4 pt-6 border-t border-gray-200">
                ...
                >
                  ...
                  {editingVehicle ? `Update ${partner.type === 'vehicle_owner' ? 'Vehicle' : 'Material'}` : `Add ${partner.type === 'vehicle_owner' ? 'Vehicle' : 'Material'}`}
                </button>
              </div>
            </form>
          </div>
